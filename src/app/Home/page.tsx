...
function Hero() {
  return (
    <div className="flex flex-col">
      <div className="w-[1440px]  bg-[#FBEBB5] flex items-center justify-between xs:w-full xs:flex-col xs:justify-between md:w-full md:flex-row md:justify-around">
        <h1 className="w-[490px] font-poppin text-[64px] leading-[96px] pt-[40px] ml-[202px] xs:w-full xs:items-center xs:justify-center xs:text-4xl xs:m-2 xs:px-6 xs:text md:text-6xl md:items-center ">
